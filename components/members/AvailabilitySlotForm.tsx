...
export default function AvailabilitySlotForm({ hostMemberId, onCreated }: Props) {
  ...
  return (
    <form onSubmit={submit} className="rounded-2xl p-5 space-y-4" style={{ background: "#F9FAFB", border: "1.5px solid #E5E7EB" }}>
      ...
      <button type="submit" disabled={saving} className="btn-primary text-sm w-full sm:w-auto">
